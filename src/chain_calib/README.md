...
태그 200은 A0 모서리에서 100 mm라 잘 뜨고, 09-18에 그 경사 1.27°가 그대로 F의
roll로 들어가 반영됐다가 09-21에 발각됐습니다. 그래서 `solve`/`check`는 기본으로
...
**0.6~0.7 px**로, 2026-09-18 세션 43개 정상 뷰 전부에서 그랬습니다(원인:
